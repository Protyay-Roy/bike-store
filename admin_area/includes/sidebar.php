    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
        ...
        <li class="dropdown"><!-- dropdown begin -->
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><!-- dropdown-toggle begin -->
                ...
                <i class="fa fa-user"></i> <?= ucwords($aName) ;?> <b class="caret"></b>
            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?change_pass"><!-- a href begin -->
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#p_cat"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-edit"></i> Product Brands
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="p_cat" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_p_cat"> Insert Product Brands </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_p_cats"> View Product Brands </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_massages"><!-- a href begin -->
                <i class="fa fa-fw fa-commenting-o"></i> View Message
                </a><!-- a href finish -->
            </li><!-- li finish -->
